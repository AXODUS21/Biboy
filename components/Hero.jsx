...
const Hero = () => {
  return (
    <Element name="hero" className="relative h-[90vh] bg-black text-white mt-20 max-sm:py-10 max-sm:h-fit">
      ...
      <div className="flex flex-col md:flex-row h-full items-center px-5 md:px-10 gap-10 md:gap-5">
        <div className="w-full md:w-1/2">
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 sm:gap-5">
            ...
            <CustomButton
              title={"Our Services"}
              customStyle={"!bg-stone-900 border-[0.2px] border-gray-600 py-4 px-8 "}
              location={"Services"}
            />
          </div>
        </div>
